...
export class Charts extends EventEmitter {
    ...
    loadChartJS() {
        ...
        return new Promise((resolve) => {
            ...
            const src = (function(){
                try {
                    return chrome.runtime.getURL('libs/chart.umd.min.js');
                } catch {
                    return 'libs/chart.umd.min.js';
                }
            })();

            const script = createElement('script', {
                src,
                onload: () => resolve(window.Chart || function(){ return { destroy(){}, update(){} }; }),
                onerror: () => resolve(window.Chart || function(){ return { destroy(){}, update(){} }; })
            });
